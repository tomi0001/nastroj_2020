        ...
        <table class='table center'>
            ...
            <tr>
                <td class="center" colspan='2'>
                    <input type="button" class="btn btn-success" onclick="sum_average2('{{route('DrDrugs.sumAverage2')}}',{{$list->id2}},{{$i}},'{{Request::get('dateStart')}}','{{Request::get('dateEnd')}}')" value="Oblicz średnią">
                </td>
