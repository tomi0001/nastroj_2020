                    ...
                    <td class="center"  width="16%" width="150px">
                     ...
                     <tr>
                        ...
                        <td>
                            ...
                            @if ($list[$i]->what_work != "")
                            <button onclick="showDescription('{{route('Drmood.showDescription')}}',{{$list[$i]->id}},{{$i}})" class='btn btn-primary btn-lg'>Co robiłeś</button>
                            @else
                        ...
                        <td>
                            ...
                            <button onclick="showAction('{{route('Draction.show')}}',{{$i}},{{$list[$i]->id}})" class='btn btn-primary btn-lg'>pokaż akcje</button>
                            @else
                        ...
                        <td>
                           ...
                           <a href='{{route('Drmain')}}/{{$list[$i]->year}}/{{$list[$i]->month}}/{{$list[$i]->day}}#id_{{$list[$i]->id}}'><button class='btn btn-primary btn-lg'>Idź do dnia</button></a>
