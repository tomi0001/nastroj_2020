  <div class="ajaxlist">
      <table class="tableAction ajaxlist">
        ...
        <tr>
            ...
            @if (App\Actions_plan::setAllDay($list2->id)->if_all_day == 1)
                <td class="tdAction"><div class="center colorLevel_percent colorLevel_percent_{{App\Http\Services\Action::setColorPercent($list2->percent_executing / 100,2 * App\Actions_plan::setAllDay($list2->id)->datediff)}}">{{round($list2->percent_executing / 100,2)  * App\Actions_plan::setAllDay($list2->id)->datediff}} %</td>
            @else
